...
logs = {'0103': ('W:\\03_Workspace\\0103-00-000.00_Книга учета времени.ods', '0103-00-000.00'),
        '0104': ('W:\\03_Workspace Pavalex\\0104-00-000.00_Книга учета времени.ods', '0104-00-000.00')
        }
...
for log in logs:
    for path in archives:
        dir_path = os.path.join(path, logs[log][1], year_string, month_string)
